...
// Get refefernce to loading screen
...
var layer_list = [
	{
		'image': background,
		'src': './images2/Cannon_Beach-1.png',
		'z_index': -2.25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': clouds,
		'src': './images2/Cannon_Beach-2.png',
		'z_index': -2,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': floaties_1,
		'src': './images2/Cannon_Beach-3.png',
		'z_index': -1.25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': floaties_2,
		'src': './images2/Cannon_Beach-4.png',
		'z_index': -0.5,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': shadows,
		'src': './images2/Cannon_Beach-5.png',
		'z_index': -1.25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 0.75
	...
	{
		'image': mask,
		'src': './images2/Cannon_Beach-6.png',
		'z_index': 0,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': humans,
		'src': './images2/Cannon_Beach-7.png',
		'z_index': 0.8,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': floaties_3,
		'src': './images2/Cannon_Beach-8.png',
		'z_index': 2,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
...
window.addEventListener('deviceorientation', function(event) {
	...
	if (window.orientation === 0) {
		...
		// The device is in landscape on it's left side
		motion.x = event.beta - motion_initial.x;
		motion.y = - event.gamma + motion_initial.y;
	} else if (window.orientation === -90) {
		// The device is in landscape on it's right side
		motion.x = - event.beta - motion_initial.x;
		motion.y = - event.gamma - motion_initial.y;
	} else {
